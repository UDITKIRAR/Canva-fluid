...
const Carding = (props) => {
  return (
    ...
    <div  style={{background: "linear-gradient(to bottom, #0f0821, #241d34)"}} className='  border-2 border-[#332c42]    md:pb-4 px-6 w-full  md:h-[400px]   md:flex-1  flex flex-col pb-10 lg:pb-4   rounded-3xl  gap-5 '>
