...
export const Contact = () => {
  ...
  return (
        ...
        <div style={gradientStyle} className=' md:mt-32 mt-4 text-[#EEE5FFBD] justify-start  md:pt-5 text-sm md:p-6  gap-4  mb-[-0.75rem] flex flex-col flex-col-reverse content-end items-center md:flex-row md:justify-between md:px-2  ' >
