...
const Chrome = () => {
  return (
    <div style={{background: "linear-gradient(to bottom, #0f0821, #241d34)"}} className='mx-5 border-2 border-[#332c42] mt-40 rounded-3xl px-3 pb-3 pt-5'>
   <div className='flex  p-8 flex-col gap-7'>
