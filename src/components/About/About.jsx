...
export const About = () => {
  return (
    <div className='mt-12  md:mt-20 flex flex-col  md:gap-0 lg:gap-4'>
      ...
      <div className='flex gap-10  lg:gap-8 lg:flex-nowrap  mt-12 mx-0 lg:flex-row lg:flex flex-col items-center justify-center lg:justify-between lg:p-5  md:p-12 md:pt-4 md:pb-4 lg:px-2 md:grid md:grid-cols-3 md:grid-rows-2  md:gap-y-14  md:gap-x-0 md:ml-12 md:mr-16 lg:mx-0 '>
