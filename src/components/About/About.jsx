...
export const About = () => {
  return (
    <div className='mt-12  md:mt-20 flex flex-col'>
      ...
      <div className='flex gap-10  lg:gap-8 lg:flex-nowrap  mt-12 mx-0 lg:flex-row lg:flex flex-col items-center justify-center lg:justify-between p-5 lg:px-2 md:grid md:grid-cols-3 md:grid-rows-2  md:gap-y-14  md:gap-x-0 md:mx-24 lg:mx-0 '>
