...
export const Experience = () => {
  return (
    <div className='mt-10 flex grid-cols-5 md:grid flex-col wrap justify-center items-center md:flex-row md:justify-between'>
      <div className=' mt-10 p-5 flex flex-col gap-4 col-span-3'>
      ...
      <div className='md:justify-end flex justify-center  col-span-2'>
