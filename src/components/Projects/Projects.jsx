...
export const Projects = () => {
  return (
    <div className='flex md:mt-36 mt-22  flex-col p-3'>
      <p style={{ fontFamily: 'Sora, sans-serif' }}  className='text-center  md:font-semibold  lg:whitespace-nowrap text-3xl md:text-4xl text-custom-purple'>Apply On Any Section Or  Enable  <br></br>
      </p>
      <p style={{ fontFamily: 'Sora, sans-serif' }} className='text-center mb-16  md:font-semibold mt-3 lg:whitespace-nowrap  text-3xl  tracking-wider md:text-4xl text-custom-purple'>For Whole Page</p>
