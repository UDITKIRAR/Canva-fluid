    ...
    <div className='flex md:mt-36 mt-22  flex-col p-3'>
      ...
      <div className='md:mx-2 mx-0'>
        <div className='flex  flex-col  md:gap-4 md:flex-row md:flex md:justify-around '>
          <div className='p-8 md:mb-20 mb-6   mb-12 border-2 border-b-[0px] border-[#332c42] rounded-2xl 'style={{background: "linear-gradient(to bottom, #0f0821, #241d34)"}}>
            <Section></Section>
          </div>
          <div className='p-8  md:mt-20  rounded-2xl border-2 border-b-[0px] border-[#332c42] ' style={{background: "linear-gradient(to bottom, #0f0821, #241d34)"}}>
          <Page></Page>
          </div>
        </div>
      </div>
