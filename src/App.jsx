...
function App() {
  ...
  return (
    ...
    <div style={gradientStyle} className=' md:mt-28 mt-3 text-[#EEE5FFBD] justify-start md:p-5   text-sm md:pb-3  gap-4 md:mb-[-1rem] mb-[0rem] flex flex-col flex-col-reverse content-end items-center md:flex-row md:justify-between md:px-2 p-5 pb-3 gap-6 ' >
