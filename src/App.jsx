...
function App() {
  ...
  return (
    ...
    <div style={gradientStyle} className=' lg:mt-28 md:mt-24 mt-6 text-[#EEE5FFBD] justify-start md:p-5   text-sm md:pb-3  gap-4 lg:mb-[-1rem] mb-[0rem] flex flex-col flex-col-reverse content-end items-center lg:flex-row lg:justify-between md:px-2 p-5 pb-3 gap-6 ' >
